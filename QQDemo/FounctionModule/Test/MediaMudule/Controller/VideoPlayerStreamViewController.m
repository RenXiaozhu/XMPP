...
- (void)changeLoadViewDate:(NSNotification *)notfication
{
    ...
    {
        DDLogInfo(@"---%f",CMTimeGetSeconds(custmoPlayer.player.currentTime) );
    ...
    {
        DDLogInfo(@"AVPlayerItemNewAccessLogEntryNotification");
    }
    else if ([notName isEqualToString:@"AVPlayerItemNewErrorLogEntryNotification"])
    {
        DDLogInfo(@"AVPlayerItemNewErrorLogEntryNotification");
    }
    ...
    {
        DDLogInfo(@"AVPlayerItemNewAccessLogEntry");
    }
