...
- (void)adjustFrame
{
    ...
    // 表格的高度
    CGFloat scrollHeight = _scrollView.frame.size.height - self.scrollViewInitInset.top - self.scrollViewInitInset.bottom;
...
{
    CGFloat h = _scrollView.frame.size.height - self.scrollViewInitInset.bottom - self.scrollViewInitInset.top;
