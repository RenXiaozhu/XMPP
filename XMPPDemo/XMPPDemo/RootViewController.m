       ...
       NavgationBarBgColor:(NSString *)imgName
{
        ...
        else
        {
            ...
            else
            {
                ...
                NSDictionary *dict=[NSDictionary dictionaryWithObjectsAndKeys:[UIFont systemFontOfSize:[[dictVaule valueForKey:@"size"] floatValue]],UITextAttributeFont,[dictVaule valueForKey:@"color"],UITextAttributeTextColor, nil];
